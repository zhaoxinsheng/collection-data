...
import io.nakong.modules.sys.dao.SysUserTokenDao;
import io.nakong.modules.sys.entity.SysUserTokenEntity;
import io.nakong.modules.sys.oauth2.TokenGenerator;
...
//			tokenEntity.setToken(token);
			...
			r = R.ok().put("token", tokenEntity.getToken()).put("expire", EXPIRE);
		}
