...
import io.nakong.modules.collect.entity.ExcelColumn;
...
//                font.setBoldweight(Font.BOLDWEIGHT_NORMAL);
        ...
        //冻结窗格
        wb.getSheet("数据").createFreezePane(0, 1, 0, 1);
        //浏览器下载excel
        buildExcelDocument("导出数据-"+ DateUtils.format(new Date()) +".xlsx",wb,response);
        //生成excel文件
