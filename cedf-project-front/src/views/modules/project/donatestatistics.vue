<template>
  <div class="mod-role">
      ...
      <el-form-item>
          <el-col class="line" :span="3">到账月份</el-col>
         <el-col :span="8">
      ...
      <div class="el-row" style="margin-left: -6px; margin-right: -6px;">
        ...
        <div class="el-col el-col-8"style="padding-left: 6px; padding-right: 6px;">
           <div class="demo-color-box bg-yellow"><font class="div-font">{{dataForm.totalDonateCashAmount|FinaceAmtFormat}}</font><div class="value">现金到账金额</div>
            </div>
         </div>
        <div class="el-col el-col-8"style="padding-left: 6px; padding-right: 6px;">
        <div class="demo-color-box bg-green-gray"><font class="div-font">{{dataForm.totalDonateMaterialAmount|FinaceAmtFormat}}</font><div class="value">物资到账金额</div>
           </div>
         </div>
        </div>
    </el-form>
